...
def add_post(request):
    form = PostForm()
    if request.method != 'POST':
        return render(request,'hod_template/add_post.html',{'form' : form})
    else:
        ...
        if form.is_valid():
            ...
            return HttpResponseRedirect(reverse("add_post_for_hod"))
...
def edit_post(request,post_id):
    ...
    return render(request,"hod_template/edit_post.html",{"form":form,"id":post_id})
...
def edit_post_save(request):
    ...
    if request.method != "POST":
        ...
        if form.is_valid():
            ...
            return HttpResponseRedirect(reverse("edit_post_for_hod",kwargs={"post_id":post_id}))


def add_tag(request):
    return render(request,"hod_template/add_tag.html")
...
def add_tag_save(request):
    if request.method!="POST":
        ...
        try:
            ...
            return HttpResponseRedirect(reverse("add_tag_for_hod"))
        except Exception as e:
...
#     model = Post
#     form_class = PostForm
#     template_name = 'hod_template/add_post.html'
#     success_url = reverse_lazy('admin_home')

# class UpdatePost(UpdateView):
#     model=Post
#     form_class = EditForm
#     template_name = 'hod_template/edit_post.html'
#     success_url = reverse_lazy('admin_home')

class DeletePost(DeleteView):
    model = Post
    template_name = 'hod_template/delete_post.html'
    success_url = reverse_lazy('admin_home')

def manage_post(request):
    posts=Post.objects.filter(author=request.user.id)
    return render(request,"hod_template/manage_post.html",{"posts":posts})
