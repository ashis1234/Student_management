...
urlpatterns = [
    ...
    path('admin_home/add_tag_save', HodViews.add_tag_save,name="add_tag_save_for_hod"),
    path('admin_home/add_post',HodViews.add_post,name = "add_post_for_hod"), 
    path('admin_home/edit_post/<str:post_id>',HodViews.edit_post,name = "edit_post_for_hod"),
    path('admin_home/edit_post_save', HodViews.edit_post_save,name="edit_post_save_for_hod"),
    path('admin_home/delete_post/<int:pk>',HodViews.DeletePost.as_view(),name = "delete_post_for_hod"),
    path('admin_home/manage_post',HodViews.manage_post,name = "manage_post_for_hod"),

    path('staff_home/add_tag', StaffViews.add_tag,name="add_tag_for_staff"),
    path('staff_home/add_tag_save', StaffViews.add_tag_save,name="add_tag_save_for_staff"),
    path('staff_home/add_post',StaffViews.add_post,name = "add_post_for_staff"), 
    path('staff_home/edit_post/<str:post_id>',StaffViews.edit_post,name = "edit_post_for_staff"),
    path('staff_home/edit_post_save', StaffViews.edit_post_save,name="edit_post_save_for_staff"),
    path('staff_home/delete_post/<int:pk>',StaffViews.DeletePost.as_view(),name = "delete_post_for_staff"),
    path('staff_home/manage_post',StaffViews.manage_post,name = "manage_post_for_staff"),

    path('student_home/add_tag', StudentViews.add_tag,name="add_tag_for_students"),
    path('student_home/add_tag_save', StudentViews.add_tag_save,name="add_tag_save_for_students"),
    path('student_home/add_post',StudentViews.add_post,name = "add_post_for_students"), 
    path('student_home/edit_post/<str:post_id>',StudentViews.edit_post,name = "edit_post_for_students"),
    path('student_home/edit_post_save', StudentViews.edit_post_save,name="edit_post_save_for_students"),
    path('student_home/delete_post/<int:pk>',StudentViews.DeletePost.as_view(),name = "delete_post_for_students"),
    path('student_home/manage_post',StudentViews.manage_post,name = "manage_post_for_students"),
